...
import com.blueskybone.arkscreen.databinding.ItemLinkHomeBinding
 ...
 *   Date: 2025/1/22
 */
class LinkHomeAdapter(private val listener: ItemListener) :
    ListAdapter<Link, LinkHomeAdapter.LinkVH>(DiffCallback) {
    ...
    inner class LinkVH(private val binding: ItemLinkHomeBinding, listener: ItemListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LinkVH {
        ...
        val binding = ItemLinkHomeBinding.inflate(inflater, parent, false)
