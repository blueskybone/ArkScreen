...
//        var targetLevel: Int = 0,         //算不出来，只有专精三可以判断(12h,24h)，专精一二由于艾丽妮的技能导致无法区分。
        ...
        var changeRemainSecs: Long = -1L,     //计算换班时间
        var changeTime: Long = -1L,
    ...
    data class Tired(
        var current: Int = -1,
        var remainSecs: Long = -1,      //遍历基建群计算，妈的算不出来
    )
