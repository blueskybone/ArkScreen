...
public class SkLandLogin extends Activity implements View.OnClickListener {
    ...
    private void switchBindingRole() throws MalformedURLException, JsonProcessingException {
        ...
        new Thread(() -> {
            ...
            } catch (MalformedURLException | JsonProcessingException | InvalidKeyException | NoSuchAlgorithmException e) {
                e.printStackTrace();
            }
            if (roleInfos == null) {
                mHandler.post(() -> {
    ...
    protected void onResume() {
        super.onResume();
        String token = "i8nLsA91t1RUcoak7OMl+tde";
